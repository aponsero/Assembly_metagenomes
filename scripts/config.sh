...
export SKESA="/rsgrps/bhurwitz/alise/tools/SKESA"
...
export ASSEMBLER="Spades" # SKESA, Spades or Megahit
export RESULT_DIR="/rsgrps/bhurwitz/alise/my_data/Nostoc_project/Lichen_metagenomes/assemblies/test_assemblers/run_test1_spades" #provide the path of an existing folder
